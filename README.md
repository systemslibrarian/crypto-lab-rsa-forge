...
- **Is this a factoring breakthrough?** No — the paper deliberately separates DT-RSA from plain factoring, and it does not recover the primes or private key. The key is extracted as a temporary capability in the oracle model, not by factoring N.
